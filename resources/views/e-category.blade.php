...
@section('container')
    <form class="max-w-screen-sm mx-auto flex flex-col justify-center" action="{{ route('u-category', [$category->f_id]) }}"
        method="POST">
    ...
    @endif
        ...
        <div class="mb-5">
            ...
            <input type="text" name="f_kategori" value="{{ $category->f_kategori }}"
