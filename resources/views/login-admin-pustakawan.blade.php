...
@section('container')
    <div class="flex flex-col items-center justify-center  h-screen bg-red-700 text-gray-700">
        <!-- Component Start -->
        <h1 class="font-bold text-2xl text-white">Login Admin / Pustakawan</h1>
        ...
        @endif
        <form class="flex flex-col bg-white rounded shadow-lg p-12 mt-5" action="{{ route('loginActionAdminPustakawan') }}"
            method="POST">
            @csrf
            ...
            <div class="flex mt-6 justify-center">
                <a class="text-red-600" href="{{ route('login-user') }}">Login User</a>
            </div>
        </form>
        <!-- Component End  -->
    </div>
